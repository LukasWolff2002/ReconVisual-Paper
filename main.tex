...
% ─────────────────────────────────────────────────────────────────────────────
% ─────────────────────────────────────────────────────────────────────────────
%  SECTION: Experimental Results  (versión final)
%  Pegar después de \subsection{Dataset} en main.tex
%  Copiar las imágenes a:
%    images/01_global_metrics_comparison.png
%    images/02_ap_per_class_comparison.png
% ─────────────────────────────────────────────────────────────────────────────
...
marqeur      & 60 & 0.859          & \textbf{0.859} & DINOv3 ($-0.001$) \\
...
DINOv3-FCOS wins in 7 of 15 evaluated classes, ties in 4, and loses in only 3.
...
DINOv3 wins in 7 of 15 evaluated classes and ties in 4, while iDoc prevails
